...
<div class="top-head">
<h1 >REFLIB | Library Management System Admin Portal</h1>
</div>
...
<div class="navbar navbar-inverse set-radius-zero" >
 ...
 <li>
                           ...
                           <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Issue Books/feedbacks <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="view-feedbacks.php">VIEW FEEDBACKS</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-book.php">Issue New Book</a></li>
